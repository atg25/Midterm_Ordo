...
export function SiteNav({ user }: SiteNavProps) {
  ...
  return (
    ...
    >
      <div className="site-container relative grid shell-nav-frame grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)] items-center gap-(--shell-rail-gap) max-sm:grid-cols-[minmax(0,1fr)_auto] max-sm:grid-rows-[auto_auto]">
        ...
        <div className="min-w-0 flex items-center justify-start max-sm:col-span-1" data-shell-nav-region="brand">
          <ShellBrand className="opacity-90" />
        </div>
        ...
        <div className="min-w-0 flex items-center justify-end justify-self-end max-sm:col-start-2 max-sm:row-start-1" data-shell-nav-region="account-access">
